    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div class="lg:col-span-7 card bg-base-100 border border-base-200 shadow-sm rounded-2xl">
            <div class="card-body p-6 sm:p-8 gap-5">
                ...
                <div
                    class="alert alert-info text-[10px] p-3.5 gap-3 rounded-xl border border-blue-200 bg-blue-50/50 text-blue-800 leading-relaxed flex items-start">
                    <svg class="w-4.5 h-4.5 text-info shrink-0 mt-0.5" fill="none" stroke="currentColor"
            ...
            <div class="card bg-base-100 border border-base-200 shadow-sm rounded-2xl">
                <div class="card-body p-6 gap-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div
                            class="badge badge-sm badge-outline font-bold text-[9px] uppercase tracking-wider py-2 px-2.5 rounded-lg border-base-300">
                            UI/UX Design
                        </div>
                    </div>
                    ...
                    <div class="space-y-3.5 border-t border-b border-base-200 py-4 my-1">
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="avatar placeholder">
                                <div
                                    class="w-8 h-8 rounded-lg bg-primary/10 text-primary font-black text-xs flex items-center justify-center">
                                    JD
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="avatar placeholder">
                                <div
                                    class="w-8 h-8 rounded-lg bg-base-200 text-gray-500 font-black text-xs flex items-center justify-center">
                                    JS
                                </div>
                            </div>
                            <div>
    ...
    <div class="card bg-base-100 border border-base-200 shadow-sm rounded-2xl overflow-hidden">
        <div class="card-body p-6 sm:p-8 gap-5">
            <div class="flex flex-col gap-1.5">
                <span class="text-[10px] font-black text-gray-400 block tracking-widest uppercase">Dokumen Review</span>
                <h4 class="text-xl font-black text-neutral-content leading-none">Preview Dokumen Laporan Project</h4>
                <p class="text-[11px] text-gray-400 font-medium leading-relaxed max-w-2xl">
                    Gunakan dokumen berikut sebagai referensi saat memberi penilaian dan catatan. Area ini dibuat lebih
